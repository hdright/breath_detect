...
from MoslehLSTM.loss import NMSE_cuda, NMSELoss, CosSimilarity, rho
from MoslehLSTM.backbone import RegLSTM
...
#         print('Model saved!')
    ...
    def model_train(self):
        ...
        for epoch in range(self.epochs):
            ...
            # training...
            for i, (seq, label) in enumerate(self.train_shuffle_loader):
                seq = seq.cuda()  # input [batch=32,2,16,32]
            ...
            with torch.no_grad():
                ...
                for i, (seq, label) in enumerate(self.test_shuffle_loader):
